...
<div class="container mt-3 d-print-none">
	<div class="row">
		<div class="col">
			<h3>Get a date range for one member</h3>
		</div>
	</div>
</div>
<div class="container mt-3 d-print-none">
  <div class="row">
    <div class="col">
      <ul class="nav justify-content-end">
        ...
        <li class="nav-item">
          <form method="POST" action="{{ url('admin/reports/daysmember_export') }}">
            {{ csrf_field() }}
...
<div class="container mt-2">
  <div class="row">
    <div class="col">
      ...
      <p class="mb-0">
        <span class="font-weight-bold">Date Range:</span> {{ $start_date }} - {{ $end_date }}
      </p>
      <p class="mb-0">
